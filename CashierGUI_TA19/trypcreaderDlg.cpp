// trypcreaderDlg.cpp : implementation file
//

#include "stdafx.h"
#include "trypcreaderDlg.h"
#include "otpreader.h"
#ifdef _DEBUG
...
CTrypcreaderDlg::CTrypcreaderDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CTrypcreaderDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CTrypcreaderDlg)
	m_nSound = -1;
	m_strAmt1 = _T("");
	m_strAmt2 = _T("");
	m_bGreen = FALSE;
...
void CTrypcreaderDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CTrypcreaderDlg)
...
BEGIN_MESSAGE_MAP(CTrypcreaderDlg, CDialog)
	//{{AFX_MSG_MAP(CTrypcreaderDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
/////////////////////////////////////////////////////////////////////////////
// CTrypcreaderDlg message handlers

BOOL CTrypcreaderDlg::OnInitDialog()
{
...
void CTrypcreaderDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CTrypcreaderDlg::OnQueryDragIcon()
{
	return (HCURSOR) m_hIcon;
}

void CTrypcreaderDlg::OnButton1() 
{
	// TODO: Add your control notification handler code here
	if (!pReader->OpenReader()) ::AfxMessageBox("Error",MB_SYSTEMMODAL);
}

void CTrypcreaderDlg::OnClose() 
{
...
void CTrypcreaderDlg::OnButton2() 
{
	// TODO: Add your control notification handler code here
	m_dwErrCode = 0;
...
void CTrypcreaderDlg::RefreshSettings()
{
...
void CTrypcreaderDlg::OnButton6() 
{
	// TODO: Add your control notification handler code here
	m_dwErrCode = 0;
	((CEdit *)GetDlgItem(IDC_EDIT_ERRCODE))->SetWindowText("0");
...
void CTrypcreaderDlg::OnButton7() 
{
	// TODO: Add your control notification handler code here
	m_dwErrCode = 0;
	((CEdit *)GetDlgItem(IDC_EDIT_ERRCODE))->SetWindowText("0");
...
void CTrypcreaderDlg::OnButton8() 
{
	// TODO: Add your control notification handler code here
	//deduct
	m_dwErrCode = 0;
...
void CTrypcreaderDlg::OnButton9() 
{
	// TODO: Add your control notification handler code here
	m_dwErrCode = 0;
	((CEdit *)GetDlgItem(IDC_EDIT_ERRCODE))->SetWindowText("0");
...
void CTrypcreaderDlg::OnButton10() 
{
	// TODO: Add your control notification handler code here
	m_dwErrCode = 0;
	((CEdit *)GetDlgItem(IDC_EDIT_ERRCODE))->SetWindowText("0");
...
void CTrypcreaderDlg::OnButton3() 
{
	// TODO: Add your control notification handler code here
	pReader->OtpReset();
}
...
void CTrypcreaderDlg::OnButton4() 
{
	// TODO: Add your control notification handler code here
	m_dwErrCode = 0;
	((CEdit *)GetDlgItem(IDC_EDIT_ERRCODE))->SetWindowText("0");
...
void CTrypcreaderDlg::OnButton5() 
{
	// TODO: Add your control notification handler code here
	m_dwErrCode = 0;
	((CEdit *)GetDlgItem(IDC_EDIT_ERRCODE))->SetWindowText("0");
