// CmdKde.h: interface for the CCmdKde class.
// 
//////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////
...
#if !defined(AFX_CMDKDE_H__C18598C1_E7F5_45A8_9FC3_70D0BD855889__INCLUDED_)
#define AFX_CMDKDE_H__C18598C1_E7F5_45A8_9FC3_70D0BD855889__INCLUDED_
...
protected:
    CCmdKde();
	CCmdKde(const CCmdKde&);
	CCmdKde& operator=(const CCmdKde&);

public:
	void CloseKDE();
	void OpenKDE();
	bool KDE_IsTicketValid();
	BYTE KDE_GetError(); // [BW] 20051202 
